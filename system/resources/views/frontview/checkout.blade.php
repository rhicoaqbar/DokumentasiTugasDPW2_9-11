...
<head>
    <meta charset="utf-8">
    <title>JamTanganJak - Online Shop Website Template</title>
                    ...
                    <div class="bg-light p-30">
                        ...
                        <div class="form-group mb-4">
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="banktransfer">Transfer Bank</label>
                            </div>
                        </div>
                        <button class="btn btn-block btn-primary font-weight-bold py-3">Pesan</button>
                    </div>
                </div>
            </div>
        </div>
